<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"D:\wamp64\www\oa\public/../application/admin\view\task\xiugai.html";i:1523941190;s:58:"D:\wamp64\www\oa\public/../application/admin\view\top.html";i:1525666750;s:59:"D:\wamp64\www\oa\public/../application/admin\view\foot.html";i:1543322190;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<link rel="stylesheet" type="text/css" href="__STATIC__/admin/task/css/add.css?9">
	<div class="write_box" id="check">
		<div class="title" style="margin-bottom: 20px;">
			<a class="glyphicon glyphicon-ok">修改任务</a>
			<a href="<?php echo url('index'); ?>" class="glyphicon glyphicon-chevron-left return">返回工作台</a>
		</div>
		<?php foreach($check as $check_info): ?>
		<form action="<?php echo url('updatexiugai'); ?>?id=<?php echo $check_info['id']; ?>"  method="post" enctype="multipart/form-data">
			<div class="form-group" style="font-size: 16px;">
				<?php foreach($user as $userdata): ?>
				<div class="form-group">
					<label>内容</label>
					<textarea name="work_name" id="myEditor" style="height: 280px;width: 100%;" ><?php echo $check_info['work_name']; ?></textarea>
				</div>
				<div class="form-group">
					<label>附件</label>
					<input type="file" name="work_require" class="dropify" data-default-file="__UPLOADS__<?php echo $check_info['work_require']; ?>">
				</div>
				<?php endforeach; ?>								
			</div>
			<div class="form-group">
