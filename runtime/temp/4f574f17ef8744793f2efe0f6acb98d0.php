<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:71:"D:\wamp64\www\oa\public/../application/admin\view\index\department.html";i:1544234685;s:58:"D:\wamp64\www\oa\public/../application/admin\view\top.html";i:1544089172;s:59:"D:\wamp64\www\oa\public/../application/admin\view\left.html";i:1544234685;s:60:"D:\wamp64\www\oa\public/../application/admin\view\right.html";i:1544234685;}*/ ?>
<!DOCTYPE html>
...
.notice_content{
	...
	<body>
		<div class="container">
			<div class="top">
				<div class="status"> 
					<div class="status_title">部门概况</div>
					<div class="img_box" id="main" ></div>
			    </div>
			    <div class="excellent">
			    	 <div class="excellent_title">优秀部门TOP3</div>
			    	 <div class="img_box" id="main_two" ></div>
			    </div>     
			</div>
			<div class="bottom">
				<div class="">
					<div class="status_title_two">优秀个人</div>
					<div class="img_box" id="main_three" ></div>
				</div>
				<div class="contribution">
					<div class="status_title_two">个人贡献</div>
					<div class="img_box_three" id="main_four" ></div>
				</div>
			</div>
		</div>	
	</body>
...
<script type="text/javascript">
	...
	var myChart_three = echarts.init(document.getElementById('main_two'));
	var pathSymbols = {
    ...
    var option = {
		    ...
		    series: [{
		        ...
		        symbol: 'path://M0,10 L10,10 C5.5,10 5.5,5 5,0 C4.5,5 4.5,10 0,10 z', //图像
		        itemStyle: {
		            normal: {
		                opacity: 0.5
		            },
