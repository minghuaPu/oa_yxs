<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:79:"D:\wampserver\wamp64\www\oa\public/../application/admin\view\index\recycle.html";i:1546652743;s:69:"D:\wampserver\wamp64\www\oa\public/../application/admin\view\top.html";i:1546932386;s:70:"D:\wampserver\wamp64\www\oa\public/../application/admin\view\left.html";i:1545118183;}*/ ?>
<!DOCTYPE html>
...
<body>
    <div class="cjp_box">
        ...
        <div class="cjp_content">
            ...
            <div style="text-align: center;"><?php echo $recycle_list->render(); ?></div>
        </div>
    </div>
    ...
    methods: {
        ...
        recoverChoose() {
            ...
            if (con == true) {
                ...
                $.post("<?php echo url('recoverDele'); ?>", {
                    proche_type:"<?php echo $recycle_type; ?>",
        ...
        //获取图片  
        getPic(re) {
            $.get("<?php echo url('recycleGetPic'); ?>", {
                proche_type:"<?php echo $recycle_type; ?>",
                id: re,
            }, function(e) {
                var a = "";
