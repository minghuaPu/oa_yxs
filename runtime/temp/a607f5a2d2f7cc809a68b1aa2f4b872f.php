<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:80:"D:\wampserver\wamp64\www\oa\public/../application/admin\view\bumen\addbumen.html";i:1544610348;s:69:"D:\wampserver\wamp64\www\oa\public/../application/admin\view\top.html";i:1546998629;s:70:"D:\wampserver\wamp64\www\oa\public/../application/admin\view\left.html";i:1546998629;s:70:"D:\wampserver\wamp64\www\oa\public/../application/admin\view\foot.html";i:1544610348;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="container" style="background: #fff">
    <h3>输入部门名称:</h3>
<form action="<?php echo url('addbumen1'); ?>" class="form" method="post" enctype="multipart/form-data">
     <div class="form-group">
    <input type="text" class="form-control" name="bumen_name" placeholder="请输入名称">
  </div>
    <div style="text-align: center;" class="form-group"><input type="submit" class="btn btn-success" style="width: 150px;">
    </div>
    </form>
