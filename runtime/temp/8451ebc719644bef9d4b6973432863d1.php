<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:76:"G:\wamp3.1.7\www\oa\oa_yxs\public/../application/admin\view\index\stock.html";i:1552980894;s:68:"G:\wamp3.1.7\www\oa\oa_yxs\public/../application/admin\view\top.html";i:1553224508;s:69:"G:\wamp3.1.7\www\oa\oa_yxs\public/../application/admin\view\left.html";i:1553765068;s:70:"G:\wamp3.1.7\www\oa\oa_yxs\public/../application/admin\view\right.html";i:1552459927;}*/ ?>
			...
			<thead>
				<tr>
						...
						<th style="text-align: center;">
							...
							<a class="btn btn-warning" href="<?php echo url('statistical'); ?>" >使用统计</a>
						</th>
    	...
    	operate(e,i){
    		if(e==2){
    			this.$confirm('确认删除吗！',  {
		          ...
		          callback: action => {
		            if(action=='confirm'){
		            	$.get('<?php echo url("admin/index/inventory"); ?>',
	        	    	{
	        	    		select:e,
