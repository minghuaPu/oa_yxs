<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"D:\wamp64\www\oa\public/../application/admin\view\index\inventory.html";i:1545812564;s:58:"D:\wamp64\www\oa\public/../application/admin\view\top.html";i:1545791874;s:59:"D:\wamp64\www\oa\public/../application/admin\view\left.html";i:1545120513;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
 ...
 function jump_qt(){
	...
	<div style="margin-left: 200px;margin-top: 20px;width: 85%;text-align: center;">                                   
		<table class="table table-striped table-bordered table-hover table-condensed">
			<thead>
				<tr>
					<!-- <form action="<?php echo url('inventory'); ?>"> -->
						<th><input type="text" class="form-control" placeholder="钢种" name="gangzhong"></th>
						<th><input type="text" class="form-control" placeholder="型号" name="type"></th>
						<th><input type="text" class="form-control" placeholder="规格" name="standard"></th>
