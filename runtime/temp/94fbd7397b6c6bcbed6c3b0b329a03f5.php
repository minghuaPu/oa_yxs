<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"D:\wamp64\www\oa\public/../application/admin\view\index\proche_rcl.html";i:1545791875;s:58:"D:\wamp64\www\oa\public/../application/admin\view\top.html";i:1545791874;s:59:"D:\wamp64\www\oa\public/../application/admin\view\left.html";i:1545120513;}*/ ?>
<!DOCTYPE html>
 ...
 function jump_qt(){
    ...
    <div class="cjp_box">
        ...
        <div class="cjp_choose">
            ...
            <a href="<?php echo url('exportDayInner',['proche_type'=>'treatment']); ?>" class="btn btn-default" onclick="return educe()">导出Excel</a>
        ...
        <div class="cjp_content">
                        ...
                        <div class="modal-body">
                            <form action="<?php echo url('addwork'); ?>" method="post" enctype="multipart/form-data">
                                <div class="form-group" style="display: none;">
                                    ...
                                    <input type="text" class="form-control" id="" name="proche_type" placeholder="请输入姓名" value="treatment">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="input-id" name="work_require[]" class="file-loading" type="file" multiple autoReplace='true'>
                                </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="<?php echo url('updatework'); ?>" method="post" enctype="multipart/form-data">
                                <div class="form-group" style="display: none;">
                                    <label for="name">产品检查类型</label>
                                    <input type="text" class="form-control" id="" name="proche_type" value="treatment">
                                </div>
                                <div class="form-group">
                                    <label>时间</label>
                                ...
                                <div class="form-group">
                                    <label for="name">上传图片</label>
                                    <input id="input-id1" name="work_require[]" class="file-loading" type="file" multiple autoReplace='true'>
                                </div>
                                <button type="button" class="btn btn-default" data-dismiss="modal">
                                    关闭
                                </button>
           ...
           <table class="table table-bordered table-hover" style="text-align: center;">
                ...
                <?php foreach($rcl_list as $key=>$info): ?>
                <tr>
            ...
            <div style="text-align: center;"><?php echo $rcl_list->render(); ?></div>
        </div>
        <!--startprint-->
        <!--打印内容开始-->
