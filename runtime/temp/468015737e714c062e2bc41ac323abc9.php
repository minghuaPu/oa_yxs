<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"D:\wampserver\wamp64\www\oa\public/../application/admin\view\index\proche_select.html";i:1546911868;s:69:"D:\wampserver\wamp64\www\oa\public/../application/admin\view\top.html";i:1546652743;s:70:"D:\wampserver\wamp64\www\oa\public/../application/admin\view\left.html";i:1545118183;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
 ...
 function jump_qt(){
    ...
    <div class="cjp_box">
        <div class="cjp_head">
            <?php if($proche_type == 'rough'): ?>
            粗加工/搜索结果
            <?php endif; if($proche_type == 'treatment'): ?>
            热处理/搜索结果
            <?php endif; if($proche_type == 'workshop'): ?>
            锻造车间/搜索结果
            <?php endif; if($proche_type == 'packaging'): ?>
            包装检验/搜索结果
            <?php endif; if($proche_type == 'machining'): ?>
            精加工/搜索结果
            <?php endif; if($proche_type == 'other'): ?>
            其他/搜索结果
            <?php endif; ?>
        </div>
            ...
            <div class="col-lg-6" style="width: 160px;">
                <div class="input-group">
                    <select id="selectchoose" class="selectpicker ab" @change="selectChange" :value="type">
                        ...
                        <?php switch($proche_type): case "workshop": ?><option value="team">设备</option><?php break; case "other": ?> <option value="name">类型</option><?php break; default: ?><option value="name">姓名</option>
                        <?php endswitch; ?>
        ...
        <div class="cjp_content">
                        ...
                        <div class="modal-body">
                            <form action="<?php echo url('updatework'); ?>" method="post" enctype="multipart/form-data">
                                <div class="form-group" style="display: none;">
                                    ...
                                    <input type="text" class="form-control" id="" name="proche_type" value="<?php echo $proche_type; ?>">
                                </div>
                                <div class="form-group" style="display: none;">
            ...
            <table class="table table-bordered table-hover" style="text-align: center;">
                <tr>
                    ...
                    <?php switch($proche_type): case "workshop": ?><th style="width: 6%;">设备</th><?php break; case "other": ?> <th style="width: 6%;">类型</th><?php break; default: ?><th style="width: 6%;">姓名</th>
                    <?php endswitch; ?>
                ...
                <tr>
                    ...
                    <?php switch($proche_type): case "workshop": ?><td><?php echo $info['team']; ?></td><?php break; default: ?><td><?php echo $info['name']; ?></td>
                    <?php endswitch; ?>
        ...
        <div style="display: none;" id="start">
            <table border="1" cellspacing="0" style="text-align: center;">
                <tr>
                    <th>序列</th>
                    <th>时间</th>
                    <?php switch($proche_type): case "workshop": ?><th>设备</th><?php break; case "other": ?> <th>类型</th><?php break; default: ?><th>姓名</th>
                    <?php endswitch; ?>
                    <th>产品名称</th>
                    <th>产品尺寸</th>
                    <th>问题描述</th>
                ...
                <tr>
                    ...
                    <?php switch($proche_type): case "workshop": ?><td>{{printMessage.team}}</td><?php break; default: ?><td>{{printMessage.name}}</td>
                    <?php endswitch; ?>
...
new Vue({
    ...
    methods: {
            ...
            if (len == "") {
                ...
                if (con == true) {
                    ...
                    $.post("<?php echo url('goRecycle'); ?>", {
                        proche_type: "<?php echo $proche_type; ?>",
        ...
        //搜索
        select() {
            var proche_type = "<?php echo $proche_type; ?>";
