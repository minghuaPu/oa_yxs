<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:82:"G:\wamp3.1.7\www\oa\oa_yxs\public/../application/admin\view\product\proche_qt.html";i:1551350420;s:68:"G:\wamp3.1.7\www\oa\oa_yxs\public/../application/admin\view\top.html";i:1552961967;s:69:"G:\wamp3.1.7\www\oa\oa_yxs\public/../application/admin\view\left.html";i:1552966307;s:70:"G:\wamp3.1.7\www\oa\oa_yxs\public/../application/admin\view\right.html";i:1552459927;}*/ ?>
<!DOCTYPE html>
...
.Score{
    ...
    <div class="cjp_box">
        ...
        <div class="cjp_content">
                        ...
                        <div class="modal-body">
                            <form action="<?php echo url('addwork'); ?>" method="post" enctype="multipart/form-data">
                                <div class="form-group" style="display: none;">
                                    ...
                                    <input type="text" class="form-control" id="" name="proche_type" placeholder="请输入姓名" value="other">
                                </div>
                                <div class="form-group" style="display: none;">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="" name="name" placeholder="请输入类型" required="required">
                                </div>
                                <div class="form-group">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="<?php echo url('updatework'); ?>" method="post" enctype="multipart/form-data">
                                <div class="form-group" style="display: none;">
                                    <label for="name">产品检查类型</label>
                                    <input type="text" class="form-control" id="" name="proche_type" value="other">
                                </div>
                                <div class="form-group" style="display: none;">
                                    <label for="name">图片路径</label>
            ...
            <div style="text-align: center;"><?php echo $qt_list->render(); ?></div>
        </div>
        <!--startprint-->
        <!--打印内容开始-->
