<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"D:\wampserver\wamp64\www\oa\public/../application/admin\view\index\cjg.html";i:1545038197;s:69:"D:\wampserver\wamp64\www\oa\public/../application/admin\view\top.html";i:1544610348;s:70:"D:\wampserver\wamp64\www\oa\public/../application/admin\view\left.html";i:1544665589;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
 ...
 function jump_cjg(){
    window.location.href='<?php echo url('admin/index/cjg'); ?>'
 }
    ...
    <div class="cjp_box">
        ...
        <div class="cjp_choose">
            ...
            <a href="<?php echo url('exportDayInner'); ?>" class="btn btn-default" onclick="return educe()">导出Excel</a>
                        ...
                        <div class="modal-body">
                            <form action="<?php echo url('addwork'); ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="" name="title" placeholder="请输入产品名称">
                                </div>
                                <div class="form-group">
                                    <label for="name">产品尺寸</label>
                                    <input type="text" class="form-control" id="" name="size" placeholder="请输入产品尺寸">
                                </div>
                                <div class="form-group">
                                    <label for="name">问题描述</label>
                                    <input type="text" class="form-control" id="" name="describes" placeholder="请输入问题描述">
                                </div>
                                <div class="form-group">
                                    <label for="name">整改情况</label>
                                    <input type="text" class="form-control" id="" name="modify" placeholder="请输入整改情况">
                                </div>
                                <div class="form-group">
                                    <label for="name">对应车间</label>
                                    <input type="text" class="form-control" id="" name="workshop" placeholder="请输入对应车间">
                                </div>
                                <div class="form-group">
                                    <label for="name">备注</label>
                                    <input type="text" class="form-control" id="" name="remarks" placeholder="请输入备注">
                                </div>
                                <div class="form-group">
