<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"D:\wamp64\www\oa\public/../application/admin\view\gongdan\add.html";i:1544063215;s:58:"D:\wamp64\www\oa\public/../application/admin\view\top.html";i:1545791874;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<link rel="stylesheet" type="text/css" href="__STATIC__/admin/task/css/add.css?3">
	<div class="write_box">
		<div class="title">
			<a class="glyphicon glyphicon-pencil">外勤工单提交</a>
			<a href="<?php echo url('index/index'); ?>" class="glyphicon glyphicon-chevron-left return">返回工作台</a>			
		</div>
		...
		<div class="from_box">
			<form action="<?php echo url('save'); ?>" class="form" method="post" enctype="multipart/form-data">
				<div class="form-group">
					<div class="form-group">
						<label>外出时间</label>
						<textarea name="outside_time" id="myEditor" style="height: 280px;width: 100%;"></textarea>
					</div>
					<div class="form-group">
						<label>外出理由</label>
						<textarea name="outside_reason" id="myEditor1" style="height: 280px;width: 100%;"></textarea>
					</div>
					<div class="form-group">
						<label>拜访人姓名</label>
						<textarea name="visitname" id="myEditor" style="height: 280px;width: 100%;"></textarea>
					</div>
					<div class="form-group">
						<label>拜访人地点</label>
						<textarea name="visitplace" id="myEditor" style="height: 280px;width: 100%;"></textarea>
					</div>
					<div class="form-group">
						<label>拜访人电话</label>
						<textarea name="visitphone" id="myEditor" style="height: 280px;width: 100%;"></textarea>
					</div>
				<div class="form-group">
