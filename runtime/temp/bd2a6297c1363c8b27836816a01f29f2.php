<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"D:\wamp64\www\OAZ\oa_yxs\public/../application/admin\view\map\check.html";i:1544063215;s:66:"D:\wamp64\www\OAZ\oa_yxs\public/../application/admin\view\top.html";i:1544063215;s:67:"D:\wamp64\www\OAZ\oa_yxs\public/../application/admin\view\left.html";i:1544063215;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class=" col-md-5">
        <template>
            ...
            <div class="block">
                <div class="col-md-6">
                    <span>日期</span>
                    <el-date-picker type="date" v-model="value1" placeholder="选择日期" style="width: 40%"></el-date-picker>
                    到
                    <el-date-picker type="date" v-model="value2" placeholder="选择日期" style="width: 40%"></el-date-picker>
                </div>
                <div class="col-md-4">
                    <span class="user">用户</span><el-input class="userinput" v-model="value3"></el-input>
                </div>
                <div class="col-md-2">
