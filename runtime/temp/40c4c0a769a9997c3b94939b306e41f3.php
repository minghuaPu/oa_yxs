<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"D:\wampserver\wamp64\www\oa\public/../application/admin\view\index\proche_bzjy.html";i:1545356621;s:69:"D:\wampserver\wamp64\www\oa\public/../application/admin\view\top.html";i:1545119997;s:70:"D:\wampserver\wamp64\www\oa\public/../application/admin\view\left.html";i:1545118183;}*/ ?>
<!DOCTYPE html>
                        ...
                        <div class="modal-body">
                            <form action="<?php echo url('addwork'); ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="input-id" name="work_require[]" type="file" multiple>
                                </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="<?php echo url('updatework'); ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="name">上传图片</label>
                                    <input id="input-id1" name="work_require[]"  type="file" multiple>
                                </div>
                                <button type="button" class="btn btn-default" data-dismiss="modal">
                                    关闭
                                </button>
