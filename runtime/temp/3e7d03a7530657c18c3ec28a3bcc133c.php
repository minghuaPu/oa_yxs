            ...
            <div class="table_box">
                <div class="Employee_box">
                    ...
                    <div class="Employee_right">
                        ...
                        <div class="Score">
                            <div class="fens">
                                <div class="se" :style="'height:'+zongshu+'%'"></div>
                                <div class="fen">{{zongshu}}分</div>
                            </div>
                        </div>
                    </div>
                    <table class="aa" style="text-align: center;" border='1px' width="1000px">
                        ...
                        <tr :bgcolor="index%2 ==0?'':'#fff'" v-for='(item,index) in worksheet'>
                            ...
                            <td>
                                <select :style="index%2 ==0?'background: #b7dee8;':''" v-model='item.primary' @change='zhuclassify(index)' :disabled='disabled'>
                            ...
                            <td>
                                <div :style="index%2 ==0?'background: #b7dee8;':''">{{item.score}}
                            </td>
...
new Vue({
    ...
    methods: {
        ...
        selectDate() {
            console.log(this.DATE)
            $.get('<?php echo url("admin/task/classify"); ?>', { select: 8, selectDate: this.DATE, }, (rtnData) => {
        ...
        add() {
            ...
            $.get('<?php echo url("admin/task/classify"); ?>', { select: 0, }, (rtnData) => {
