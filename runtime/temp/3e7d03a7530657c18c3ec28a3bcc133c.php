<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"D:\wampserver\wamp64\www\oa\public/../application/admin\view\task\index.html";i:1546998629;s:69:"D:\wampserver\wamp64\www\oa\public/../application/admin\view\top.html";i:1547536341;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    data: {
     ...
     methods:{
     	...
     	zhipairw(e){
      	...
      	open4(){
	        // this.$alert('<table  class="table table-striped table-bordered table-hover table-condensed"><tr><th>员工建议</th><th>提建议时间</th></tr><tr v-for="item in advise"><td>{{item.advise}}</td><td>{{item.time}}</td></tr></table>', 'HTML 片段', {
