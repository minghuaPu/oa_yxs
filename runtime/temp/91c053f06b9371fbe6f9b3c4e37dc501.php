<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:84:"G:\wamp3.1.7\www\oa\oa_yxs\public/../application/admin\view\product\proche_dzcj.html";i:1551350420;s:68:"G:\wamp3.1.7\www\oa\oa_yxs\public/../application/admin\view\top.html";i:1552961967;s:69:"G:\wamp3.1.7\www\oa\oa_yxs\public/../application/admin\view\left.html";i:1552962429;s:70:"G:\wamp3.1.7\www\oa\oa_yxs\public/../application/admin\view\right.html";i:1552459927;}*/ ?>
<!DOCTYPE html>
...
.Score{
    ...
    <div class="cjp_box">
        ...
        <div class="cjp_choose">
            ...
            <a href="<?php echo url('exportDayInner',['proche_type'=>'workshop']); ?>" class="btn btn-default" onclick="return educe()">导出Excel</a>
        ...
        <div class="cjp_content">
                        ...
                        <div class="modal-body">
                            <form action="<?php echo url('addwork'); ?>" method="post" enctype="multipart/form-data">
                                <div class="form-group" style="display: none;">
                                    ...
                                    <input type="text" class="form-control" id="" name="proche_type" placeholder="请输入姓名" value="workshop">
                                </div>
                                <div class="form-group" style="display: none;">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="" name="team" placeholder="请输入设备" required="required">
                                </div>
                                <div class="form-group">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="<?php echo url('updatework'); ?>" method="post" enctype="multipart/form-data">
                                <div class="form-group" style="display: none;">
                                    <label for="name">产品检查类型</label>
                                    <input type="text" class="form-control" id="" name="proche_type" value="workshop">
                                </div>
                                <div class="form-group" style="display: none;">
                                    <label for="name">图片路径</label>
                                ...
                                <div class="form-group">
                                    <label for="name">设备</label>
                                    <input type="text" class="form-control" id="" name="team" :value="message.team">
                                </div>
                                <div class="form-group">
                                    <label for="name">产品名称</label>
            ...
            <table class="table table-bordered table-hover" style="text-align: center;">
                ...
                <?php foreach($dzcj_list as $key=>$info): ?>
                <tr>
            ...
            <div style="text-align: center;"><?php echo $dzcj_list->render(); ?></div>
        </div>
        <!--startprint-->
        <!--打印内容开始-->
