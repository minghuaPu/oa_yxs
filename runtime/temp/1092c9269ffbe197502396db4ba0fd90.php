<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:77:"G:\wamp3.1.7\www\oa\oa_yxs\public/../application/admin\view\stock\gc_djb.html";i:1554346206;s:68:"G:\wamp3.1.7\www\oa\oa_yxs\public/../application/admin\view\top.html";i:1553224508;s:69:"G:\wamp3.1.7\www\oa\oa_yxs\public/../application/admin\view\left.html";i:1554174855;s:70:"G:\wamp3.1.7\www\oa\oa_yxs\public/../application/admin\view\right.html";i:1552459927;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="container">
    ...
    <el-row>
        <el-col class="rl_box" :span="24" style="width: 98%;">
            <el-row>
                <el-col :span="24">
                    <el-row class="lanmu_title">钢材库存登记表</el-row>
                    <el-row class="bt">
                        <el-col class="wk_title" :span="2" v-for="wk in week_a">{{wk}}</el-col>
                    </el-row>
                    <el-row v-for="(kc,k) in week_d" :class="{'lanse':k%2==0,'huise':k%2!=0}">
                    ...
                    <el-row>
                        <el-col :span="6" style="margin:15px 0px">
                            <el-button onclick="location.href='<?php echo url('gc_rk'); ?>'" type="primary">钢材入库</el-button>
                            <el-button  onclick="location.href='<?php echo url('gc_ck'); ?>'"  type="primary">钢材出库</el-button>
                        </el-col>
                        <el-col :span="10"><?php echo $gc_data->render(); ?></el-col>
                        <el-col :span="8" style="margin:15px 0px">
                            <el-input v-model="gangzhong_kwd" style="width: 70%;margin-right: 15px">
...
<script>
    ...
    new Vue({
        el: '.container',
        data: {
            week_a: ['钢种', '型号', '规格', '单重', '单位', '出库数量', '总重量', '备注', '炉号', '管理员'],
            week_d: [],
            gangzhong_kwd:""
        },
        created() {
        ...
        methods: {
            doSearch(){
                location.href="<?php echo url('gc_djb'); ?>"+"?gangzhong_kwd="+this.gangzhong_kwd
            }
        }
    })
</script>